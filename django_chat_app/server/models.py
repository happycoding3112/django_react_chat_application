...
def category_icon_upload_path(instance, filename):
    return "category/{instance_id}/category_icon/{filename}".format(
        instance_id=instance.id, filename=filename
    )


def server_banner_upload_path(instance, filename):
    return "server/{server_id}/server_banner/{filename}".format(
        server_id=instance.id, filename=filename
    )


def server_icon_upload_path(instance, filename):
    return "server/{server_id}/server_icon/{filename}".format(
        server_id=instance.id, filename=filename
    )
